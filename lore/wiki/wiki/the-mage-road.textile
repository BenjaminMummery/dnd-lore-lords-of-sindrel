...
<!-- GM_INFO_START -->
The mage road is dotted with the ruins of **transference towers** from the Soulwind conduit (~3226 SC). For two decades the link was a functioning **two-way** connection between [[Soulwind | Soulwind]] and [[Sindrel | Sindrel]], and supplied burst power to refocus the rift between world-targets. It was **destroyed** when **Riftlock** was executed (~3245 SC). Only the stone shells remain.
<!-- GM_INFO_END -->
